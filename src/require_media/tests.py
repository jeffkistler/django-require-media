...
class RequirementTestCase(unittest.TestCase):
    def test_initialization(self):
        ...
        self.assertEquals("jquery.js", requirement.requirement)
        self.assertFalse(requirement.group)
        self.assertEquals([], requirement.depends)
        ...
        self.assertEquals("jquery-ui.js", requirement.requirement)
        self.assertEquals("js", requirement.group)
        self.assertEquals(["jquery.js"], requirement.depends)
...
class InlineRequirementTestCase(unittest.TestCase):
    def test_initialization(self):
        ...
        self.assertEquals("test", requirement.requirement)
...
class RequirementManagerTestCase(unittest.TestCase):
    def test_determine_requirement_group(self):
        groups = ["css", "js"]
        self.assertEquals("js", manager.determine_requirement_group("jquery.js", groups))
        self.assertEquals("js", manager.determine_requirement_group("http://example.com/url/example.js", groups))
        self.assertEquals("js", manager.determine_requirement_group("http://example.com/url/example.js?query=string&example", groups))
        self.assertEquals(None, manager.determine_requirement_group("var a = null;", groups))
        self.assertEquals("css", manager.determine_requirement_group("reset.css", groups))
        self.assertEquals("css", manager.determine_requirement_group("http://example.com/css/reset.css", groups))
        self.assertEquals("css", manager.determine_requirement_group("http://example.com/css/reset.css?query=string&example", groups))
        self.assertEquals(None, manager.determine_requirement_group("h1 { background: #fff; }", groups))
    ...
    def test_add_external_group(self):
        ...
        self.assertEquals(0, len(requirement.depends))
    ...
    def test_add_external_depends(self):
        ...
        self.assertEquals("jquery-ui.js", requirement.requirement)
        self.assertEquals("js", requirement.group)
        self.assertEquals(1, len(requirement.depends))
        self.assertEquals("jquery.js", requirement.depends[0])
    ...
    def test_add_inline(self):
        ...
        self.assertEquals("foo", requirement.requirement)
    ...
    def test_sort_requirements(self):
        ...
        m.add_external("jquery.ui.accordion.js", depends=["jquery.ui.core.js", "jquery.ui.accordion.js", "jquery.effects.scale.js"])
        m.add_external("jquery.effects.scale.js", depends=["jquery.js", "jquery.effects.core.js"])
        m.add_external("jquery.ui.core.js", depends=["jquery.js"])
        m.add_external("jquery.js")
        m.add_external("jquery.effects.core.js", depends=["jquery.js"])
        ordered = m.sort_requirements()
        names = [requirement.requirement for requirement in ordered]
        self.assertEquals(["jquery.js", "jquery.ui.core.js", "jquery.effects.core.js", "jquery.effects.scale.js", "jquery.ui.accordion.js"], names)
...
class RequireTagTestCase(RequestMiddlewareTestCase):
    def test_simple_with_group(self):
        ...
        self.assertTrue("jquery.js" in requirement_manager.requirement_map)
    ...
    def test_depends_simple(self):
        ...
        requirement_manager = getattr(request, settings.REQUEST_ATTR_NAME, None)
        self.assertEquals(1, len(requirement_manager.requirements))
        self.assertTrue("jquery-ui.js" in requirement_manager.requirement_map)
        self.assertEquals("js", requirement_manager.requirements[0].group)
        self.assertEquals(1, len(requirement_manager.requirements[0].depends))
        self.assertEquals("jquery.js", requirement_manager.requirements[0].depends[0])
    ...
    def test_requirement_alias(self):
        ...
        self.assertTrue("jquery.js" in requirement_manager.requirement_map)
        self.assertEquals("js", requirement_manager.requirements[0].group)
        self.assertEquals(0, len(requirement_manager.requirements[0].depends))
    ...
    def test_requirement_group_alias(self):
        ...
        requirement_manager = getattr(request, settings.REQUEST_ATTR_NAME, None)
        self.assertEquals(1, len(requirement_manager.requirements))
        print requirement_manager.requirement_map
        self.assertTrue("jquery.js" in requirement_manager.requirement_map)
        self.assertEquals("js", requirement_manager.requirements[0].group)
        self.assertEquals(0, len(requirement_manager.requirements[0].depends))
...
class RequireInlineTagTestCase(RequestMiddlewareTestCase):
    def test_simple(self):
        ...
        self.assertEquals("sidebar", requirement.requirement)
        self.assertEquals("css", requirement.group)
